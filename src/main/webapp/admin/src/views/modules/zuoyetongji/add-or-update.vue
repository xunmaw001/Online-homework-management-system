<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="作业编号" prop="zuoyebianhao">
          <el-select v-model="ruleForm.zuoyebianhao" placeholder="请选择作业编号">
            <el-option
                v-for="(item,index) in zuoyebianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提交人数" prop="tijiaorenshu">
          <el-input v-model="ruleForm.tijiaorenshu" 
              placeholder="提交人数" clearable  :readonly="ro.tijiaorenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提交人数" prop="tijiaorenshu">
              <el-input v-model="ruleForm.tijiaorenshu" 
                placeholder="提交人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合格人数" prop="hegerenshu">
          <el-input v-model="ruleForm.hegerenshu" 
              placeholder="合格人数" clearable  :readonly="ro.hegerenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合格人数" prop="hegerenshu">
              <el-input v-model="ruleForm.hegerenshu" 
                placeholder="合格人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyebianhao = true;
          ...
          if(o=='tijiaorenshu'){
            this.ruleForm.tijiaorenshu = obj[o];
	    this.ro.tijiaorenshu = true;
            continue;
          }
          if(o=='hegerenshu'){
            this.ruleForm.hegerenshu = obj[o];
	    this.ro.hegerenshu = true;
            continue;
          }
          if(o=='userid'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zuoyetongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zuoyetongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
