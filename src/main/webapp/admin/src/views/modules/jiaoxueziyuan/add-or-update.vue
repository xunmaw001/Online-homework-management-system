<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="视频资源" prop="shipinziyuan">
          <file-upload
          tip="点击上传视频资源"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shipinziyuan?ruleForm.shipinziyuan:''"
          @change="shipinziyuanUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.shipinziyuan" label="视频资源" prop="shipinziyuan">
            <el-button type="text" size="small" @click="download(ruleForm.shipinziyuan)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="资源分享" prop="ziyuanfenxiang">
          <file-upload
          tip="点击上传资源分享"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.ziyuanfenxiang?ruleForm.ziyuanfenxiang:''"
          @change="ziyuanfenxiangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.ziyuanfenxiang" label="资源分享" prop="ziyuanfenxiang">
            <el-button type="text" size="small" @click="download(ruleForm.ziyuanfenxiang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.peitu = true;
          ...
          if(o=='shipinziyuan'){
            this.ruleForm.shipinziyuan = obj[o];
	    this.ro.shipinziyuan = true;
            continue;
          }
          if(o=='ziyuanfenxiang'){
            this.ruleForm.ziyuanfenxiang = obj[o];
	    this.ro.ziyuanfenxiang = true;
            continue;
          }
          if(o=='ziyuanjieshao'){
	...
	this.ruleForm.ziyuanjieshao = this.ruleForm.ziyuanjieshao.replace(reg,'../../../ssm10r7g/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    shipinziyuanUploadChange(fileUrls) {
	this.ruleForm.shipinziyuan = fileUrls;
			this.addEditUploadStyleChange()
    },
    ziyuanfenxiangUploadChange(fileUrls) {
	this.ruleForm.ziyuanfenxiang = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
