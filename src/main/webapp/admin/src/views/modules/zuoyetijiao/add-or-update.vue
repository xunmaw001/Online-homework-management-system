<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="作业提交" prop="zuoyetijiao">
          <file-upload
          tip="点击上传作业提交"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyetijiao" label="作业提交" prop="zuoyetijiao">
            <el-button type="text" size="small" @click="download(ruleForm.zuoyetijiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
