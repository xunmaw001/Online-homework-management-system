  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
        <h1 class="h1" style="color:#000;fontSize:28px;">在线作业管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学生" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuesheng" autocomplete="off" placeholder="学生"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="教师" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshi" autocomplete="off" placeholder="教师"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
